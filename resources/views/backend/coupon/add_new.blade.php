...
<div class="content-wrapper container-xxl p-0">
	...
	<div class="card">
		<!--begin::Form-->
		<form class="form" action="{{ route(currentUser().'.coupon.store') }}" method="POST" enctype="multipart/form-data">
			@csrf
			...
			<div class="card-body">
				<div class="row form-group">
					...
					<div class="col-lg-4 mb-1">
						...
						<input type="text" name="code" value="{{ old('code') }}" class="form-control @if($errors->has('code')) {{ 'is-invalid' }} @endif" placeholder="Food Item name" />
						@if($errors->has('code'))
						<small class="d-block text-danger mb-3">
							{{ $errors->first('code') }}
						</small>
...
<div class="form-group row">
					...
					<div class="col-lg-2 mb-1">
						...
						<input type="text" name="discount" class="form-control @if($errors->has('discount')) {{ 'is-invalid' }} @endif" value="{{old('discount') }}" />
					...
					<div class="col-lg-2 mb-1">
						...
						<input type="text" name="max_discount" class="form-control @if($errors->has('max_discount')) {{ 'is-invalid' }} @endif" value="{{old('discount') }}" />
					...
					<div class="col-lg-3 mb-1">
						...
						<input type="date" name="expires_at" class="form-control @if($errors->has('expires_at')) {{ 'is-invalid' }} @endif" value="{{old('discount') }}" />
