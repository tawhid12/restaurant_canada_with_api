...
<div class="content-wrapper container-xxl p-0">
    <div class="content-header row">
      <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
          <div class="col-12">
            <h2 class="content-header-title float-start mb-0">Category Add</h2>
	...
	<div class="card">
		<form class="form" action="{{ route(currentUser().'.addNewCategory') }}" method="POST" enctype="multipart/form-data">
			@csrf
