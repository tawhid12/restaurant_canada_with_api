...
@section('content')
    @push('styles')
        <style>
            ...
            #content {
                /* Additional styling for your content container if needed */
                padding: 20px;
            }
        </style>
    @endpush
    ...
    <section class="restaurant-detailed-banner">
        <div class="text-center">
            <img class="img-fluid cover"
                src="{{ asset('/') }}storage/app/public/images/feature_image/{{ $restaurant->feature_image }}">
        </div>
                ...
                <div class="row d-flex align-items-end">
                    <div class="col-md-8">
                        <div class="restaurant-detailed-header-left">
                            <img class="{{ asset('') }}assets/img-fluid mr-3 float-left" alt="osahan"
                                src="{{ asset('/') }}storage/app/public/images/logo/{{ $restaurant->logo }}">
                            ...
                            <p class="text-white mb-1"><i class="icofont-location-pin"></i>{{ $restaurant->address }}
                                ...
                                @else
                                    <span class="badge badge-success">OPEN</spa>
                                @endif
                            </p>
                            @php
                                ...
                                $delivery_time_slot = [1 => '15-20 min', 2 => '20-30 min', 3 => '30-40 min', 4 => '40-50 min'];
                            @endphp
                    ...
                    <div class="col-md-4">
                        <div class="restaurant-detailed-header-right text-right">
                            <button class="btn btn-success" type="button"><i class="icofont-clock-time"></i>
                                @if (array_key_exists($restaurant->delivery_time, $delivery_time_slot))
                                    {{ $delivery_time_slot[$restaurant->delivery_time] }}
                                @endif
                            </button>
            ...
            <div class="row">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-order-online" role="tabpanel"
                                ...
                                <div id="#menu" class="bg-white rounded shadow-sm p-4 mb-4 explore-outlets">
                                    ...
                                    <h6 class="mb-3">Most Popular
                                        <!--<span class="badge badge-success"><i class="icofont-tags"></i> 15% Off All Items </span>-->
                                    </h6>
                                        ...
                                        @forelse($popular as $p)
                                            <div class="item">
                                                <div class="mall-category-item">
                                                    <a href="#">
                                                        <img class="img-fluid"
                                                            src="{{ asset('') }}assets/img/list/1.png">
                                                        <h6>Burgers</h6>
                                                        <small>5 ITEMS</small>
                                                    </a>
                                                </div>
                                ...
                                <div class="row">
                                    @forelse($categories as $cat)
                                        @if ($cat->products->count() > 0)
                                            <h5 class="mb-4 mt-3 col-md-12">{{ $cat->name }} <small
                                                    class="h6 text-black-50">{{ $cat->products->count() }} ITEMS</small>
                                            </h5>
                                            <div class="col-md-12">
                                                        ...
                                                        @if ($loop->index < 1)
                                                            <div class="gold-members p-3 border-bottom">
                                                                ...
                                                                <span class="count-number float-right">
                                                                    <button
                                                                        class="btn btn-outline-secondary  btn-sm left dec_{{ $food->id }}"
                                                                        onclick="qty_decrement({{ $food->id }})"> <i
                                                                            class="icofont-minus"></i> </button>
                                                                    <input
                                                                        class="count-number-input qty_{{ $food->id }}"
                                                                        type="text" value="1" readonly="">
                                                                    <button
                                                                        class="btn btn-outline-secondary btn-sm right inc_{{ $food->id }}"
                                                                        onclick="qty_increment({{ $food->id }})"> <i
                                                            ...
                                                            <div class="gold-members p-3 border-bottom">
                                                                ...
                                                                <div class="media">
                                                                    @if ($loop->index % 2 == 0)
                                                                        ...
                                                                        <div class="media-body">
                                                                            <h6 class="mb-1">{{ $food->name }} <span
                                                                                    class="badge badge-success">BESTSELLER</span>
                                                                            </h6>
                                                                            <p class="text-gray mb-0">
                            ...
                            <div class="tab-pane fade" id="pills-gallery" role="tabpanel"
                                ...
                                <div id="gallery" class="bg-white rounded shadow-sm p-4 mb-4">
                                    <div class="restaurant-slider-main position-relative homepage-great-deals-carousel">
                                        ...
                                        <div class="position-absolute restaurant-slider-pics bg-dark text-white">Total
                                            {{ $restaurant->galleries->count() }} Photos</div>
                            ...
                            <div class="tab-pane fade" id="pills-restaurant-info" role="tabpanel"
                                ...
                                <div id="restaurant-info" class="bg-white rounded shadow-sm p-4 mb-4">
                                    ...
                                    <p class="mb-2 text-black"><i class="icofont-phone-circle text-primary mr-2"></i>
                                        @if ($restaurant->phone)
                                            +{{ $restaurant->phone }},
                                        @endif +{{ $restaurant->mobile }}
                                    </p>
                                    <p class="mb-2 text-black"><i class="icofont-email text-primary mr-2"></i> <a
                                            href="" class="">{{ $restaurant->email }}</a></p>
                                    <p class="mb-2 text-black"><i class="icofont-clock-time text-primary mr-2"></i> Today
                                        11am – 5pm, 6pm – 11pm
                                    ...
                                    <div class="reviews-members pt-4 pb-4">
                                        <div class="media">
                                            <a href="#"><img alt="Generic placeholder image"
                                                    src="{{ asset('') }}assets/img/user/1.png"
                                                ...
                                                <div class="reviews-members-footer">
                                                    ...
                                                    <span class="total-like-user-main ml-2" dir="rtl">
                                                        <a data-toggle="tooltip" data-placement="top"
                                                            title="Gurdeep Osahan" href="#"><img
                                                                alt="Generic placeholder image"
                                                                src="{{ asset('') }}assets/img/user/5.png"
                                                                class="total-like-user rounded-pill"></a>
                                                        <a data-toggle="tooltip" data-placement="top"
                                                            title="Gurdeep Singh" href="#"><img
                                                                alt="Generic placeholder image"
                                                                src="{{ asset('') }}assets/img/user/2.png"
                                                                class="total-like-user rounded-pill"></a>
                                                        <a data-toggle="tooltip" data-placement="top"
                                                            title="Askbootstrap" href="#"><img
                                                                alt="Generic placeholder image"
                                                                src="{{ asset('') }}assets/img/user/3.png"
                                                                class="total-like-user rounded-pill"></a>
                                                        <a data-toggle="tooltip" data-placement="top" title="Osahan"
                                                            href="#"><img alt="Generic placeholder image"
                                                                src="{{ asset('') }}assets/img/user/4.png"
                                                                class="total-like-user rounded-pill"></a>
                                                    </span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="reviews-members-footer">
                                                    <a class="total-like" href="#"><i
                                                        ...
                                                        href="#"><i class="icofont-thumbs-down"></i> 1K</a>
                                                    <span class="total-like-user-main ml-2" dir="rtl">
                                                        <a data-toggle="tooltip" data-placement="top"
                                                            title="Gurdeep Osahan" href="#"><img
                                                                alt="Generic placeholder image"
                ...
                <div class="col-md-4">
                    ...
                    <div class="generator-bg rounded shadow-sm mb-4 p-4 osahan-cart-item">
                                ...
                                @foreach ($products as $item)
                                    <div class="gold-members p-2 border-bottom">
                                        <p class="text-gray mb-0 float-right ml-2">
                                            {{ $cart[$item->id]['price'] * $cart[$item->id]['quantity'] }}</p>
                                        <span class="count-number float-right">
                                            <button class="btn btn-outline-secondary  btn-sm left dec_{{ $item->id }}"
                                                onclick="qty_decrement({{ $item->id }})"> <i
                                                    class="icofont-minus"></i> </button>
                                            <input class="count-number-input qty_{{ $item->id }}" type="text"
                                                value="1" readonly="">
                                            <button class="btn btn-outline-secondary btn-sm right inc_{{ $item->id }}"
                                                onclick="qty_increment({{ $item->id }})"> <i
                                                    class="icofont-plus"></i> </button>
                                        </span>
                                        <div class="media">
                                            <div class="mr-2"><i class="icofont-ui-press text-danger food-item"></i>
                                            </div>
                                            <div class="media-body">
                                                <p class="mt-1 mb-0 text-black">{{ $item->name }}
                                                    {{ $cart[$item->id]['price'] }} x {{ $cart[$item->id]['quantity'] }}
                                                </p>
                                            </div>
                                            <a href="javascript:void(0)" onclick="remove_cart({{ $item->id }})"
                                                class="mr-2"><i class="icofont-bin text-danger"
                        ...
                        <div class="mb-2 bg-white rounded p-2 clearfix cart-calc">
                            ...
                            <h6 class="font-weight-bold text-right mb-2">SubTotal : <span
                                    class="text-danger">${{ number_format($total, 2) }}</span></h6>
                            <h6 class="font-weight-bold text-right mb-2">Discount : <span
                                    class="text-danger">${{ number_format($t_discount, 2) }}</span></h6>
                            <h6 class="font-weight-bold text-right mb-2">Delivery Fee : <span
                                        class="text-danger">${{ number_format($delivery_fee, 2) }}</span></h6>
                            <h6 class="font-weight-bold text-right mb-2">Total : <span
                                    class="text-danger">${{ number_format($total+$delivery_fee - $t_discount, 2) }}</span></h6>
                            <!-- <p class="seven-color mb-1 text-right">Extra charges may apply</p> -->
                            @if ($t_discount > 0)
                                <p class="text-black mb-0 text-right">You have saved ${{ number_format($t_discount, 2) }}
                                    on the bill</p>
                            @endif
                        </div>
                        {{-- @if (count((array) session('cart')) > 0) --}}
                        <a href="{{ route('cart') }}" class="btn btn-success btn-block btn-lg">Checkout <i
...
@push('scripts')
    <script>
        ...
        function showLoadingSpinner() {
            // Display a loading spinner or any other indication of activity
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response.cart, function(index, item) {
                        ...
                        t_discount += item.discount * item.quantity;
                    ...
                    data += `<div class="mb-2 bg-white rounded p-2 clearfix">
                            <img class="img-fluid float-left" src="{{ asset('') }}assets/img/wallet-icon.png">
                            <h6 class="font-weight-bold text-right mb-2">SubTotal : <span
                                    class="text-danger">${total}</span></h6>
                            <h6 class="font-weight-bold text-right mb-2">Discount : <span
                                    class="text-danger">${t_discount}</span></h6>
                            <h6 class="font-weight-bold text-right mb-2">Delivery Fee : <span
                                    class="text-danger">${delivery_fee}</span></h6>
                            <h6 class="font-weight-bold text-right mb-2">Total : <span
                                    class="text-danger">${total+delivery_fee - t_discount}</span></h6>`;
                            if (t_discount > 0){
                                data +=`<p class="text-black mb-0 text-right">You have saved ${t_discount}
                                    on the bill</p>`;
                            }
